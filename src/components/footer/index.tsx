      ...
      <div className="max-w-4xl mx-auto flex flex-col gap-[20px] md:flex-row md:gap-[75px]">
        <div className="flex flex-col gap-[20px]">
          <div className="flex items-center gap-2">
            <img src="/image/logo_footer.png" alt="Pionero" className="h-10" />
          </div>
          <div className="space-y-2">
            <p className="flex items-center gap-4 font-medium text-base leading-6">
              <img src="/image/icon_phone.png" alt="Pionero" className="h-[20px]" />
              <span>094 1302662</span>
            </p>
            <p className="flex items-center gap-4 font-medium text-base leading-6">
              <img src="/image/icon_mail.png" alt="Pionero" className="h-[20px]" />
              <a href="/" className="hover:underline">contact@en.pionero.io</a>
            </p>
          </div>
        </div>
        {/* Thông tin văn phòng */}
        ...
        <div className="flex flex-col gap-[28px] ">
          ...
          <div className="flex flex-row gap-[24px]">
            <img src="/image/icon_fb.png" alt="facebook" className="w-[36px]" />
            <img src="/image/icon_linkedln.png" alt="linkedlv" className="w-[36px]" />
            <img src="/image/icon_X.png" alt="x" className="w-[34px]" />
          </div>
        </div>
