    ...
    <header className="relative bg-[#F4F8FE]">
      ...
      <div className="md:flex md:pl-[450px] md:pr-[364px] md:flex-row md:gap-[75px]">
        <div className="max-md:px-[20px] pb-[31px] md:pb-[41px]">
          ...
          />
          <img src="image/Polygon 1.png" alt="Polygon" className="absolute md:top-[65%] left-[53%] md:w-[106px] max-md:!hidden" />
          <img src="image/Ellipse 1.png" alt="Ellipse" className="absolute top-[70%] md:left-[64%] w-[40px] md:w-[80px] max-md:!hidden" />
        </div>
